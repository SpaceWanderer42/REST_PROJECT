...
class Base:
    ...
    def retrieve_all(self, endpoint=''):  # they are paged, improperly said all
    ...
    def retrieve(self, ID=''):
        ...
        try:
            ...
            response_data = json.loads(response.text) # Careful here
            return response_data # And here
    ...
    def verifying_action(self, action, api_url, payload):
        """ Verify if an object exists in the api when using update or semi-update. """
    ...
    def cleanup(self):
        """ Delete everything that has been created from the console in a specific run """
    ...
    def delete(self, ID=""):
        ...
        if ID == "":
            if self.api[-1].isdigit():
                pass  # For giving retrieve before the cleanup

            else:
                self.api = self.api + '/' + str(self.id)  # For giving cleanup without retrieve before
...
class Users(Base):
    ...
    def check_and_post(self, users_payload):
        ...
        try:
            ...
            load = self  # self -> current class as object
    ...
    def update(self):
        """ PUT into the api based on the api_url and the payload. """
    ...
    def semi_update(self, *args):
        """ PATCH into the api based on the api_url and the payload. """
